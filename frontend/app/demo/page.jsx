...
export default function DemoPage() {
  ...
  const mockProduct = {
    ...
    description:
      "iPhone mới 100%, nguyên seal, bảo hành 12 tháng chính hãng Apple.",
    metadata: {
      condition: "new",
      warranty: "12 months",
      ...
      <div className="max-w-6xl mx-auto px-4">
              ...
              <div className="space-y-6">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
                    <li>
                      Seller có thể cập nhật mô tả chi tiết hơn sau khi đăng sản
                      phẩm
                    </li>
                    <li>
                      Lưu lịch sử thay đổi mô tả (ai sửa, sửa gì, khi nào)
                    </li>
                ...
                <UpdateProductDescription
                  ...
                  onUpdate={(updatedProduct) => {
                    ...
                    setToast({
                      type: "success",
                      message:
                        "✅ Component callback: Product đã được cập nhật!",
                    });
                  }}
                />
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-red-800 space-y-1 list-disc list-inside">
                    <li>
                      Seller có thể từ chối bidder có lịch sử giao dịch xấu
                    </li>
                    <li>Vô hiệu hóa tất cả bids và auto-bids của bidder</li>
                    <li>
                      Tự động chuyển người thắng sang bidder thứ 2 (nếu cần)
                    </li>
                    <li>
                      Thêm vào blacklist, không cho bidder này đặt giá lại
                    </li>
                  </ul>
                ...
                <div className="bg-white border-2 border-gray-200 rounded-lg p-4">
                  ...
                  <RejectBidder
                    ...
                    onReject={(result) => {
                      ...
                      setToast({
                        type: "success",
                        message: "✅ Component callback: Bidder đã bị từ chối!",
                      });
                    }}
                  />
                </div>
              ...
              <div className="space-y-6">
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-orange-800 space-y-1 list-disc list-inside">
                    ...
                    <li>
                      Tự động chuyển người thắng sang bidder thứ 2 (nếu đang
                      thắng)
                    </li>
                ...
                <div className="bg-white border-2 border-blue-200 rounded-lg p-6">
                  <div className="mb-6">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Bạn đang là{" "}
                      <strong className="text-green-600">người thắng</strong>{" "}
                      hiện tại
                    </p>
                  </div>
                  ...
                  <WithdrawBid
                    ...
                    onWithdraw={(result) => {
                      ...
                      setToast({
                        type: "success",
                        message:
                          "✅ Component callback: Đã rút giá thành công!",
                      });
                    }}
                  />
                </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
          ...
          <ul className="text-sm text-yellow-800 space-y-2">
            <li>
              <strong>Backend phải đang chạy:</strong>{" "}
            ...
            <li>
              <strong>Cần login:</strong> Các API yêu cầu authentication token
              (Bearer Token)
            </li>
            <li>
              <strong>Mock data:</strong> Trang này sử dụng dữ liệu giả để demo
              UI. Khi test thật cần dùng productId thật từ database
            </li>
            <li>
              <strong>Console logs:</strong> Mở DevTools (F12) để xem
              request/response từ API
            </li>
            <li>
              <strong>Postman Testing:</strong> Xem file{" "}
              <code className="bg-yellow-100 px-2 py-1 rounded">
                API_TESTING_GUIDE_3.2_3.3.md
              </code>{" "}
              để test API chi tiết
            </li>
          </ul>
        </div>
      </div>
