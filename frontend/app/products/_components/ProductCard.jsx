        ...
        <div className="relative aspect-[4/3] bg-gray-100 dark:bg-gray-800/50 overflow-hidden flex items-center justify-center">
          {!imgError ? (
            <img
              src={imgSrc}
              alt={product.name}
              className="w-full h-full object-contain p-2 group-hover:scale-110 transition duration-700"
              onError={() => {
          ...
          >
            <Heart
              className={`w-4 h-4 transition ${isWatchlisted ? 'fill-red-500 text-red-500' : 'text-gray-600 dark:text-gray-200 group-hover/btn:text-red-500'
                }`}
            />
          </button>
        </div>
          ...
          <div className="mt-auto pt-4 border-t border-gray-100 dark:border-white/10">
            <div className="flex justify-between items-end mb-3">
              ...
              <div className="text-right">
                ...
                <span className={`text-sm font-bold flex items-center gap-1 justify-end ${isEndingSoon() ? 'text-red-500' : 'text-orange-600 dark:text-orange-400'
                  }`}>
