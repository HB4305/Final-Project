        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-4 animate-fade-in">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-primary to-blue-600 text-white rounded-xl hover:shadow-lg hover:shadow-primary/30 transition-all hover:scale-105 active:scale-95 flex items-center gap-2 font-bold transform"
            >
