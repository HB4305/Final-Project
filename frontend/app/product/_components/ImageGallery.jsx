    ...
    <div className="space-y-4">
      ...
      >
        <img
          ...
          alt="Product"
          className="w-full h-full object-contain p-2 cursor-zoom-in transition-transform duration-700 group-hover:scale-110"
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 custom-scrollbar">
          {validImages.map((img, idx) => (
            <button
              ...
              className={`relative w-24 h-24 flex-shrink-0 rounded-xl overflow-hidden border-2 transition-all ${selectedIndex === idx
