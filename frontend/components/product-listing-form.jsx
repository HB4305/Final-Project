          ...
          <form className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className={`w-full px-5 py-3 rounded-xl bg-white/5 border text-white placeholder-gray-500 focus:ring-2 focus:ring-primary/50 focus:border-primary transition outline-none ${errors.title ? 'border-red-500' : 'border-white/10'
                  }`}
              />
              {errors.title && (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  className={`w-full px-5 py-3 rounded-xl bg-white/5 border text-white focus:ring-2 focus:ring-primary/50 focus:border-primary transition outline-none appearance-none cursor-pointer ${loadingCategories ? 'opacity-50 cursor-not-allowed' : ''
                    } border-white/10`}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  {...register("categoryId")}
                  className={`w-full px-5 py-3 rounded-xl bg-white/5 border text-white focus:ring-2 focus:ring-primary/50 focus:border-primary transition outline-none appearance-none cursor-pointer ${errors.categoryId ? 'border-red-500' : 'border-white/10'
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="0"
                      className={`w-full pl-4 pr-12 py-3 rounded-xl bg-white/5 border focus:ring-2 focus:ring-primary/50 focus:border-primary transition outline-none font-bold text-white placeholder-gray-500 ${errors.startPrice ? 'border-red-500' : 'border-white/10'
                        }`}
                    />
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="0"
                      className={`w-full pl-4 pr-12 py-3 rounded-xl bg-white/5 border focus:ring-2 focus:ring-primary/50 focus:border-primary transition outline-none font-bold text-white placeholder-gray-500 ${errors.priceStep ? 'border-red-500' : 'border-white/10'
                        }`}
                    />
                    <span className="absolute right-4 top-1/2 -translate-y-1/2 text-white text-sm font-bold">VND</span>
                  </div>
            ...
            <div className="space-y-2">
              ...
              <div className={`rounded-2xl overflow-hidden border-2 ${errors.description ? 'border-red-500' : 'border-white/20'
                }`}>
                <ReactQuill
                  value={description}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                {!mainImage ? (
                  <div className={`border-2 border-dashed rounded-2xl p-6 text-center transition-all duration-300 relative group cursor-pointer hover:border-blue-500/50 hover:bg-blue-500/5 ${errors.mainImage ? 'border-red-500 bg-red-900/10' : 'border-blue-500/30 bg-blue-500/5'
                    }`}>
                    <input
                      type="file"
                      accept="image/*"
              ...
              <div className="space-y-3">
                ...
                <div className={`border-2 border-dashed rounded-2xl p-6 text-center transition-all duration-300 relative group cursor-pointer hover:border-primary/50 hover:bg-primary/5 ${errors.additionalImages ? 'border-red-500 bg-red-900/10' : 'border-white/10 bg-white/5'
                  }`}>
                  <input
                    type="file"
                    multiple
          ...
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[100] p-4 animate-fade-in">
            <div className="glass-card bg-[#1e293b] rounded-2xl shadow-2xl max-w-md w-full p-8 transform transition-all scale-100 animate-slide-up border border-white/10">
              <div className="flex flex-col items-center text-center">
                <div className={`w-20 h-20 rounded-full flex items-center justify-center mb-6 ${showSuccessModal ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'
                  }`}>
